...
// run
// g++ -o ./src/main ./src/2_list.cpp 
// ./src/main ./dataset/100000.csv ./dataset/ADD10000.csv
...
int main(int argc, char* argv[]){
    ...
    // list_solution
    ofstream list_file;
    list_file.open("output.csv");
    list_file << title << "\n";

    // in list structure I cant access the datas with using index,
    //so I used iterator for that
    for(auto it = employees.begin(); it != employees.end(); it++){
        int id = (*it)->get_id();
