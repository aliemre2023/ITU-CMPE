...
// run
// g++ -o ./src/main ./src/1_binary_tree.cpp 
// ./src/main ./dataset/25000.csv ./dataset/DELETE10000.csv
...
void BinaryTree::printInorder(Node* root, ofstream& bt_file)
{
    ...
    while (curr != NULL || s.empty() == false) {
        ...
        bt_file << curr->employee->get_id() << ";" << curr->employee->get_salary() << ";" << curr->employee->get_department() << "\n";
